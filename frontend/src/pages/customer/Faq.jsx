						...
						<RightItemStyles>
							<ul>
								...
								<li>
									...
									<p>
										입문/심화/데뷔 그 어떤 클래스 도중에라도 쓰신 원고의
										완성도가 충분히 높다고 판단되면 바로 데뷔도 가능합니다.
									</p>
									<p>
										클래스들은 작가 데뷔까지의 실력을 갖추기 위한 과정이라고
										보시면 됩니다.
									</p>
								</li>
								...
								<li>
									<h3>
										3. 원고를 보낼 경우, 정해진 기한이나 양식이 따로 있나요?{' '}
									</h3>
									<p>
									...
									<p>
										양식은 따로 없으나, 3만자 이상 5만자 미만으로 분량은
										지켜주셔야 합니다.
									</p>
								</li>
								...
								<li>
									<h3>
										5. 입문반은 장르 불문 모든 지망생들이 들어도 되는걸까요?
									</h3>
									<p>
										입문반은 장르에 상관없이 웹소설 집필에 관심있는 분들은
										누구나 수강 가능한 과정입니다.
									</p>
								</li>
								<li>
								...
								<li>
									<h3>
										7. 장학생으로 선정되어 모든 과정을 완료하면, 출판사와
										계약한다고 되어 있는데, 스토리튠즈와 계약한다는 것인가요?
									</h3>
									<p>
										기본적으로 스토리튠즈 혹은 판시아(카카오 자체 CP) 중에
										선택지가 주어지지만, 장학생이 원할 경우 다른 출판사 주선도
										가능합니다.
									</p>
								</li>
							</ul>
