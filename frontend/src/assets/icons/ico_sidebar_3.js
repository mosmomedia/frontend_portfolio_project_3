function ico_sidebar_3() {
	return (
		...
		st0"
				fill="#919191"
				d="M23.853,24.5h-7.706C15.698,24.607,7.5,26.649,7.5,32.212v1.398c3.294,3.027,7.674,4.89,12.5,4.89 s9.206-1.863,12.5-4.89v-1.398C32.5,26.652,24.302,24.607,23.853,24.5z"
			/>
			<path
				className="st0"
				fill="#919191"
				d="M20,39c-4.754,0-9.314-1.783-12.838-5.021L7,33.83v-1.618c0-5.97,8.662-8.11,9.031-8.198 L16.147,24l7.822,0.014C24.338,24.102,33,26.242,33,32.212v1.618l-0.162,0.148C29.314,37.217,24.754,39,20,39z M8,33.389 C11.316,36.364,15.569,38,20,38s8.684-1.636,12-4.611v-1.177c0-5.022-7.422-7.016-8.208-7.212h-7.585 C15.422,25.196,8,27.189,8,32.212V33.389z"
			/>
			<g>
				<path
					className="st2"
					fill="transparent"
					d="M20,20.5c-3.584,0-6.5-2.916-6.5-6.5s2.916-6.5,6.5-6.5s6.5,2.916,6.5,6.5S23.584,20.5,20,20.5z"
				/>
				<path
					className="st0"
					fill="#919191"
